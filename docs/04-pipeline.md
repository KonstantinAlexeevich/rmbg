...
В v1 в интерфейсе один пресет, редактируемый пользователем, но тип и хранилище уже
рассчитаны на список: добавление готовых пресетов маркетплейсов позже не потребует миграции.
...
- Имя файла в архиве: `<исходное имя без расширения>.<новое расширение>`. При коллизии
